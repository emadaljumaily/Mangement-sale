...
int yy;
    ...
    public Changepass() {
        initComponents();
        this.setTitle("تغيير كلمة سر الدخول");
        this.setLocationRelativeTo(null);
          this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("change password.png")));
    }
    ...
    private void initComponents() {
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/imgg/ok.png"))); // NOI18N
        jButton5.setText("تغيير");
        ...
        jLabel2.setText("كلمة المرور الجديدة");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
      ...
      try{  Statement stmt = con.createStatement();
            int rs = stmt.executeUpdate("ALTER LOGIN["+userr+"] WITH PASSWORD='"+login+"'");
                       
                      
      
      String SMessage = "تم تغيير كلمة السر بنجاح";
