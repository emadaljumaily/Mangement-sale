...
public class Calculator extends javax.swing.JFrame {
    ...
    public Calculator() {
        initComponents();
        this.setTitle("حاسبة عمليات حسابية");
    ...
    private void initComponents() {
        ...
        jButton11.setPreferredSize(new java.awt.Dimension(45, 31));
        ...
        jButton14.setPreferredSize(new java.awt.Dimension(45, 31));
        ...
        lcd.setBackground(new java.awt.Color(153, 153, 255));
        lcd.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lcd, javax.swing.GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lcd, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
...
lcd.setText(lcd.getText() + "0");
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
       if(!lcd.getText().toString().contains(".")){
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
       String del=lcd.getText().toString();
       if(del.length()>0){
    ...
    private void Calculation() {
       double fn=Double.valueOf(fv);
       double ln=Double.valueOf(lv);
       double result=0.0;
       switch(op){
           case "multi":
           result=fn * ln;
